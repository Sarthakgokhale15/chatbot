  ...
  _scoreMessage(score){
    if(score <= 30){
      return (<View style={styles.innerContainer} >
                ...
                <Text style={styles.score}>You have no Covid-19 symptoms</Text>
                <Text style={styles.score}>Your probability of contracting Covid-19 is {score}%</Text>
              </View>)
      ...
      return (<View style={styles.innerContainer} >
                  ...
                  <Text style={styles.score}>You have Covid-19 symptoms </Text>
                  <Text style={styles.score}>Your probability of contracting Covid-19 is {score}% </Text>
                </View>)
    }else if(score >= 60){
      return (<View style={styles.innerContainer}>
